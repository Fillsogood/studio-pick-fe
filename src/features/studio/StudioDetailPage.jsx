  ...
  useEffect(() => {
    const fetchStudio = async () => {
      ...
      setStudio({
        ...
        rating: 4.8,
        description:
          "화양재 스튜디오는 강동구 화양동에 위치한 자연광 스튜디오로, 제품 촬영과 인물 촬영에 적합한 다양한 공간을 제공합니다.",
        size: "150평",
        openTime: "09:00",
        closeTime: "22:00",
        maxPeople: 200,
        ...
        owner: {
          name: "정승호",
          intro:
            "10년 이상의 사진작가 경험을 바탕으로 최적의 촬영 환경을 제공하기 위해 노력하고 있습니다.",
    ...
    <div className="p-8 max-w-screen-xl mx-auto">
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-500">
          {studio.shortLocation} · {studio.category}
        </p>
      ...
      <section className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <ul className="text-gray-700 list-disc list-inside">
            ...
            <li>
              운영 시간: {studio.openTime} - {studio.closeTime}
            </li>
        ...
        <div>
          ...
          <ul className="text-gray-700">
            ...
            <li>추가 인원당: {studio.price.extraRate.toLocaleString()}원</li>
            <li>
              주말 대여 (1시간): {studio.price.weekendRate.toLocaleString()}원
            </li>
          </ul>
        </div>
      </section>
