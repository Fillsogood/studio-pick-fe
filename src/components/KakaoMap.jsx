...
export default function KakaoMap({ location, onAddressSelected }) {
      ...
      try {
        ...
        geocoder.addressSearch(trimmed, (result, status) => {
          ...
          if (onAddressSelected) {
            onAddressSelected(result[0].address_name);
          }
        });
      } catch (err) {
  ...
  return (
    <div ref={mapContainerRef} className="w-full h-[300px] rounded border" />
  );
}
